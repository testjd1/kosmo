...
/*
	...
	상속 (Inheritance) : 객체지향 언어의 꽃
		부모 클래스의 필드와 메소드, 이너클래스를 자식 클래스에서 물려준다.
		자식 클래스는 부모 클래스의 코드를 간결하게 사용
		유지보수 쉽게 가능
		다향성 사용 : 부모 클래스의 메소드를 자식 클래스에서 재 정의해서 사용
				-> 다양한 타입으로 사용 가능
...
class Human{	//  사람 :  - 부모 클래스, 자식 클래스의 공통적 필드, 메소드 선언
	// 필드
	String name;
	int age;
...
public class Using_Inheritance01 {
	...
	public static void main(String[] args) {
		...
		s.studentID = 1000;			// Student클래스에 존재하는 필드
